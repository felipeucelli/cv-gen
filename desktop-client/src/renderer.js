...
// Modificando a função de geração de currículo para solicitar a pasta
document.getElementById('gerar-curriculo').addEventListener('click', () => {
    if (selectedJson) {
        solicitarPasta()
            .then(pasta => {
...
// Função que atualiza o JSON selecionado (exemplo)
